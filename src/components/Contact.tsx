      ...
      <div className='grid md:grid-cols-2 gap-10'>
        ...
        <div className='space-y-8'>
            <div className='flex flex-col gap-1' data-aos="zoom-in-up">
                ...
                <input type='text'
                className='h-[40px] bg-transparent border border-lime-600'
                id='name'/>
            </div>
            <div className='flex flex-col gap-1' data-aos="zoom-in-up">
            ...
            <div className='flex flex-col gap-1' data-aos="zoom-in-up">
                ...
                <textarea
                className='bg-transparent border border-lime-600'
                id='message' rows={8}>
                </textarea>
            </div>
            <button className='bg-lime-600 p-2 px-6' data-aos="zoom-in-up">Send</button>
        </div>
      </div>
    </div>
  )
